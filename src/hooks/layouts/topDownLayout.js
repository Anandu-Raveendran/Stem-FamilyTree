...
const TOP_DOWN_NODE_SPREAD = SINGLE_WIDTH;
const TOP_DOWN_GENERATION_GAP = 500;

export function buildTopDownLayout(forestRoot, members) {
  ...
  const treeLayout = d3
    .tree()
    .nodeSize([TOP_DOWN_NODE_SPREAD, TOP_DOWN_GENERATION_GAP])
    .separation((a, b) => {
